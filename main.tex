...
\section{Transformée de Fourier Rapide (FFT)}
\section{Propriétés de la FFT}
\section{Implémentation de la FFT}
\section{Applications à la compression d'une image}
\section{Applications à la compression du son}
