...
Bien que l'implémentation fidèle de l'algorithme de Cooley-Tukey décrit précédemment se révèle bien plus efficaces que l'algorithme naïf, issu de la définition de la TFD, il reste très lent comparé à l'implémentation de référence pour python fournie dans le module numpy.
