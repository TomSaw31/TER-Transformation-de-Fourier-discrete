...
La DCT peut être vue comme une décomposition du signal sur une base orthogonale de cosinus de fréquences croissantes. L'avantage des cosinus comparés aux exponentielles complexes de la transformée de Fourier réside dans le fat que les valeurs obtenues restent réelles.
...
$$x_n = \sum_{k=1}^{N-1}\alpha_k X_k\cos \left[\frac{\pi}{N}\left(n+\frac{1}{2}\right)k\right], \qquad k = 0,1,\dots,N-1$$
