...
\usepackage[backend=biber, language=french, sorting=none]{biblatex} % bibliographie en fr
\addbibresource{refs.bib}
\DeclareFontFamily{U}{wncy}{}
\DeclareFontShape{U}{wncy}{m}{n}{<->wncyr10}{}
\DeclareSymbolFont{mcy}{U}{wncy}{m}{n}
\DeclareMathSymbol{\Sha}{\mathord}{mcy}{"58} % symbole Sha du peigne de Dirac
%% Autorise BibLaTeX à couper les URL de manière plus agressive
\setcounter{biburlnumpenalty}{7000} % Coupe après les chiffres
\setcounter{biburlucpenalty}{7000}  % Coupe après les majuscules
\setcounter{biburllcpenalty}{7000}  % Coupe après les minuscules
...
\begin{titlepage}
    ...
    \begin{flushleft}
        \includegraphics[width=6cm]{images/logo-UT-site.png}
    \end{flushleft}
    ...
    {\large Sous la direction de \Large \textsc{Philippe Monnier}\par}

    \vspace{1.5cm}

    \rule{0.6\textwidth}{0.4pt} \\ [0.5cm]
    {\Huge \bfseries Transformation de Fourier discrète et applications à la compression d'image\par}
    \vspace{0.3cm}
