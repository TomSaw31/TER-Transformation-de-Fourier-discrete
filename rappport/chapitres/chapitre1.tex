...
\caption{Jospeh Fourier (1768-1830).}\label{wrap-fig:1}
\includegraphics[width=4cm]{images/joseph_fourier.jpg}
\end{wrapfigure}

Au début du XVIII\textsuperscript{ème}, le mathématicien Josep Fourier travaille à la résolution de l'équation de la chaleur, une équation aux dérivées partielles modélisant le phénomène de conduction thermique.
