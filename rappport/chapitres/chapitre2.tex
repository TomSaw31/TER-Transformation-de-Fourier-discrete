...
L'intérêt, pour le traitement du signal, de la distribution de Dirac est sa capacité à isoler une valeur ponctuelle d'un signal. Pour toute fonction $g$ continue en $t_0$, on obtient la relation suivante :
\begin{align*}
